      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 mb-5">
            <p>
              Parents are welcome to reach out for any questions about
              admissions. For information on the enrollment process or available
              programs, please contact us by phone or email. We’re here to help
              you and look forward to welcoming you to our school community!
            </p>
            <div class="d-flex">
              <i
              ...
              <div class="pl-3">
                ...
                >
                <h5>Address</h5>
                <p class="custom-link-text">Mentay Vari Thota, Bhimavaram, Andhra Pradesh 534201</p>
              </a>
              </div>
            </div>
            <div class="d-flex">
              ...
              <div class="pl-3">
                ...
                >
                <h5>Email</h5>
                <p class="text-dark">allukrishna6@gmail.com</p>
              </a>
              </div>
            </div>
            <div class="d-flex">
              ...
              <div class="pl-3">
                <a href="tel:+91 9392758577" class="text-decoration-none">
                  <h5>Phone</h5>
                  <p class="custom-link-text">+91 9392758577</p>
                </a>
              </div>
            </div>
            <div class="d-flex">
              ...
              <div class="pl-3">
                ...
                <p class="m-0">09:00 AM - 04:30 PM</p>
              </div>
            </div>
          </div>
        </div>
