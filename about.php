          ...
          <div class="col-lg-7">
            ...
            <div class="fade-effect">
              <p class="pr-4.5">
                ...
                Our committed faculty employs diverse instructional strategies to challenge every student, 
                while our comprehensive support system, including trained counsellors and mentorship programs, 
                promotes resilience and emotional intelligence. 
                We actively engage families and local organizations to foster a strong community network, 
                ensuring students feel a sense of belonging and motivation. Ultimately, 
                our goal is to prepare students not just for academic grades, 
                But for lifelong learning and responsible citizenship, empowering them to become confident, 
                compassionate individuals ready to make meaningful contributions and all round development to the society.
              </p>
            </div>
          </div>
          <div class="col-lg-5">
